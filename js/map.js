...
L.control
	.layers(
		baseMaps,
		{
			'<img src="legend/KantorBupati_9.png" /> Kantor Bupati':
				layer_KantorBupati_9,
			'<img src="legend/kantorcamat_8.png" /> kantor camat':
				layer_kantorcamat_8,
			'<img src="legend/kantorkepaladesa_7.png" /> kantor kepala desa':
				layer_kantorkepaladesa_7,
			'<img src="legend/Jalan_6.png" /> Jalan': layer_Jalan_6,
			'<img src="legend/Sungai_5.png" /> Sungai': layer_Sungai_5,
			'<img src="legend/pemerintahansleman_4.png" /> pemerintahan sleman':
				layer_pemerintahansleman_4,
			'<img src="legend/sawah_3.png" /> sawah': layer_sawah_3,
			'<img src="legend/sawahtadahhujan_2.png" /> sawah tadah hujan':
				layer_sawahtadahhujan_2,
			'<img src="legend/DesaSleman_1.png" /> Desa Sleman': layer_DesaSleman_1,
